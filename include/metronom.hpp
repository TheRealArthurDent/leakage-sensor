...
public:
     ...
     * In this case \c true will make metronom's
     * \c waitForNextCycle just wait until the next regular cycle,
     * thereby skipping at least one cycle, whereas \c false will
     * make metronom's \c waitForNextCycle return immediately and
     * thereby trigger the next iteration of the loop in order to make up the
     * delay.
     *
